...
try:
    ...
    # Proste zapytanie INSERT
    stmt = text("INSERT INTO Client (id_client, name, last_name, nickname, email, country, num_tel, age) VALUES (100001, 'name', 'surname', 'namesurname', 'name.surname@gmail.com', 'Poland', '123-456-789', 26)")
    ...
    print(f"Liczba dodanych rekordów: {result.rowcount}")
